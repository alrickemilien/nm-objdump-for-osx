...
static apply_property(t_mach_o_builder *builder, int key, const char *value_str)
{
...
int build_mach_o_from_conf(t_mach_o_builder *builder, const char *path)
{
  ...
  */
  ...
  static const struct by_chelou mach_header_keys_map_g[] = {
    ...
    { "flags", &builder->header.header64.flags },
    { "reserved", &builder->header.header64.reserved },
    NULL,
  };
  ...
  */
  ...
  static const struct by_chelou load_command_g[] = {
  ...
  */
  ...
  static const struct by_chelou section_keys_map_g[] = {
