...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   check_object_integrity.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: aemilien <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/15 13:25:35 by aemilien          #+#    #+#             */
/*   Updated: 2019/09/15 13:28:28 by aemilien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		struct load_command *lc)
{
	...
	i = 0;
	while (i < sizeof(g_map_lc_checkers)
			/ sizeof(t_lc_integrity_check))
	{
...
int									check_load_commands_integrity(
		t_mach_o *file)
{
	size_t				i;
...
int32_t								check_object_integrity(
		t_mach_o *file)
{
